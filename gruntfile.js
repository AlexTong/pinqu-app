...
module.exports = function (grunt) {
				...
				options: {
					process: function (content, srcPath) {
						if (srcPath == "public/common.js") {
							...
							content = content.replace(/\/\/REPLACE_START[\s\S]*\/\/REPLACE_END/, newConfigs.join("\n\t\t"));
	...
	grunt.task.registerMultiTask("build", "Build all...", function () {
		...
		configure.serviceUrlPrefix = endWithDelim(configure.serviceUrlPrefix);

		configure.siteRoot = configure.contextPath;
